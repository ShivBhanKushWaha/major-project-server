  ...
  try {
    ...
    const patientDetails = await prisma.patientDetails.create({
      data: {
        ...
        treatment : treatment || "unavailable",
        whichFamilyMember : familyMember || "unavailable",
        symptomsOfPatient,
        whenProblemStart,
        previousPatientTreatment,
        freqOfSymptoms,
        ...
        capacityOfWork,
        sleepProper,
        timeOfSleep : timeOfSleep || "unavailable",
        eatingProperly,
        interestedToDoSomething,
        notInterested : notInterested || "unavailable",
        selfTime,
        notSelfTime : notSelfTime || "unavailable",
        doctorId: doctor.id
      }
    });
